      ...
      <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4 justify-center lg:justify-start relative z-50">
            ...
            {/* CV chooser */}
            <DownloadCvMenu label={t.hero.downloadCV} />
          </div>
        </motion.div>
          ...
          <GlassCard className="p-8 border-primary/20 bg-black/60 relative z-10">
            ...
            <div className="grid grid-cols-2 gap-4">
              {stats.map((stat, i) => (
                <div
                  key={i}
                  className="bg-white/5 p-4 rounded-xl border border-white/5 hover:border-primary/30 transition-colors"
                >
